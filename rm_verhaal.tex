...
\caption*{\footnotesize De plakploeg van de SDAP in 1925. Opa staat achter het bord met hoed.}
\end{figure}
...
\caption*{\footnotesize Harry staat achter mij}
\end{figure} 
...
\caption*{\footnotesize Familie Perk (achter het postkantoor)}
\end{figure}
...
\caption*{\footnotesize Familie Fris op de Gedempte Gracht}
\end{figure}
