...
\begin{figure}[t]
\includegraphics[width=\textwidth]{img/...}
\caption{(foto met Roel van Duyn)}
\end{figure}

\begin{figure}[t]
\includegraphics[width=\textwidth]{img/...}
\caption{Op de foto voor het huis van Van Duijn links Roel van Duijn, 3e van rechts Rob Stolk en helemaal rechts op de foto Rens Adelaar ook uit Zaandam.}
\end{figure}
